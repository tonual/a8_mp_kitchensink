...
scr = $AA00;
	...
	dlist: array [0..19] of byte = (
		...
		$70,
		$70,
		$C5,lo(scr),hi(scr), //$C5 address ekranu, adres ladowania, $C5 - $85(numer trybu)
        $85, $85, $85, $85, $85,
        $85, $85, $85, $85, $85, $85,
	...
	fntTable: array [0..29] of byte = (
		hi(fnt0),hi(fnt0),hi(fnt0),hi(fnt0),hi(fnt0),hi(fnt0),hi(fnt1),hi(fnt1),
		hi(fnt1),hi(fnt1),hi(fnt1),hi(fnt1),hi(fnt2),hi(fnt10),hi(fnt10),hi(fnt10),
	...
	c1Table: array [0..29] of byte = (
		$70,$80,$28,$28,$28,$28,$28,$28,
		$80,$28,$80,$80,$70,$70,$70,$70,
		$70,$70,$70,$70,$70,$70,$70,$70,
		$70,$70,$70,$70,$70,$70
	);
